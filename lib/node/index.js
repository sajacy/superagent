...
Request.prototype.redirects = function(n, withPost){
  this._maxRedirects = n;
  this._redirectwithpost = !!withPost;
  return this;
};
...
Request.prototype.redirect = function(res){
  ...
  // in case of POST etc
  var header = utils.cleanHeader(this.req._headers, this._redirectwithpost);
  delete this.req;

  // force GET
  if(!this._redirectwithpost) {
